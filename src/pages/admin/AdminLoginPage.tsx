    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
      <div className="bg-white rounded-lg shadow-md overflow-hidden max-w-md w-full">
        <div className="bg-gray-900 p-6 text-white text-center">
          ...
          <h1 className="text-2xl font-serif font-bold">لوحة تحكم المطعم</h1>
          <p className="text-gray-400">قم بتسجيل الدخول للوصول إلى لوحة التحكم</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="mt-6 text-center text-sm text-gray-500">
            <p>للتجربة، استخدم:</p>
            <p className="font-medium text-gray-700">اسم المستخدم: admin / كلمة المرور: password123</p>
          </div>
        </form>
      </div>
    </div>
